...
Si отзывы *${war}*предупреждения вы будете автоматически удалены из группы`, who)
        } else if (warn == war) {
            ...
            m.reply(`♻️Ты был исключен из группы *${groupMetadata.subject}*потому что он был предупрежден *${war}* разы`, who)
        }
}
